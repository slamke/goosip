...
/**
 * [The passive thread: reply to incoming gossip request.] This class handles the passive cycle, where this client
 * has received an incoming message. For now, this message is always the
